...
So for Einsums, Metal is not viable for the general case, because quantum chemistry needs double precision. The 2.9 TFLOPS FP32 on the GPU is actually the
...
Quick wins (complete half-built passes):
  ...
  2. GEMMBatching rewrite step: detection exists, rewrite doesn't. Batched-GEMM dispatch
