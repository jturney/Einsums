   ...
   'einsums_add_compile_test': { 'kwargs': { 'COMPONENT_DEPENDENCIES': '+',
    ...
    'einsums_add_library': { 'kwargs': { 'AUXILIARY': '+',
                         ...
                         'pargs': { 'flags': ['EXCLUDE_FROM_ALL',
                                               ...
                                               'UNITY_BUILD'],
                                    'nargs': '1+'}},
    'add_einsums_library_headers': { 'kwargs': {'EXCLUDE': '+', 'GLOBS': '+'},
                                 'pargs': {'flags': ['APPEND'], 'nargs': '2+'}},
    'add_einsums_library_headers_noglob': { 'kwargs': { 'EXCLUDE': '+',
                                                    'HEADERS': '+'},
                                        'pargs': { 'flags': ['APPEND'],
                                                   'nargs': '1+'}},
    'add_einsums_library_sources': { 'kwargs': {'EXCLUDE': '+', 'GLOBS': '+'},
                                 'pargs': {'flags': ['APPEND'], 'nargs': '2+'}},
    'add_einsums_library_sources_noglob': { 'kwargs': { 'EXCLUDE': '+',
                                                    'SOURCES': '+'},
                                        'pargs': { 'flags': ['APPEND'],
                                                   'nargs': '1+'}},
    'einsums_add_module': { 'kwargs': { 'CMAKE_SUBDIRS': '+',
                        ...
                        'pargs': { 'flags': ['CUDA',
                                   ...
                                   'nargs': '1+'}},
    'add_einsums_performance_test': {'pargs': {'nargs': 2}},
    'add_einsums_pseudo_dependencies': {'pargs': {'nargs': 0}},
    'add_einsums_pseudo_dependencies_no_shortening': {'pargs': {'nargs': 0}},
    'add_einsums_pseudo_target': {'pargs': {'nargs': 0}},
    'add_einsums_regression_compile_test': {
                              'kwargs': { 'COMPONENT_DEPENDENCIES': '+',
                                          'DEPENDENCIES': '+',
                                          'FOLDER': 1,
                                          'SOURCES': '+',
                              ...
                              'pargs': { 'flags': ['FAILURE_EXPECTED', 'NOLIBS'],
                                         'nargs': '2+'}},
    'add_einsums_regression_test': { 'kwargs': { 'COMPONENT_DEPENDENCIES': '+',
                                             'DEPENDENCIES': '+',
                                             'FOLDER': 1,
                                             'SOURCES': '+',
                                             'SOURCE_ROOT': 1,
                              ...
                              'pargs': { 'flags': ['FAILURE_EXPECTED',
                                         ...
                                         'nargs': '2+'}},
    'add_einsums_source_group': { 'kwargs': { 'CLASS': 1,
                                          'NAME': 1,
                                          'ROOT': 1,
                                          'TARGETS': '+'},
                              'pargs': {'flags': [], 'nargs': '*'}},
    'add_einsums_test': { 'kwargs': { 'ARGS': '+',
                                  'EXECUTABLE': 1,
                                  'LOCALITIES': 1,
                                  'PARCELPORTS': '+',
                                  'THREADS_PER_LOCALITY': 1},
                      'pargs': {'flags': ['FAILURE_EXPECTED',
                                          ...
                                          'NO_PARCELPORT_MPI'],
                                'nargs': '2+'}},
    'add_einsums_test_target_dependencies': { 'kwargs': {'PSEUDO_DEPS_NAME': 1},
                                          'pargs': {'flags': [], 'nargs': '2+'}},
    'add_einsums_unit_compile_test': {
                              'kwargs': { 'COMPONENT_DEPENDENCIES': '+',
                                          'DEPENDENCIES': '+',
                                          'FOLDER': 1,
                                          'SOURCES': '+',
