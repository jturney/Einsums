...
struct EINSUMS_EXPORT Einsums_ThreadsBase_vars final : design_pats::Lockable<std::recursive_mutex> {
    EINSUMS_SINGLETON_DEF(Einsums_ThreadsBase_vars)

    // Put module-global variables here.

  private:
    explicit Einsums_ThreadsBase_vars() = default;
};
