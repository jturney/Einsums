...
struct EINSUMS_EXPORT Einsums_Coroutines_vars final : design_pats::Lockable<std::recursive_mutex> {
    EINSUMS_SINGLETON_DEF(Einsums_Coroutines_vars)

    // Put module-global variables here.

  private:
    explicit Einsums_Coroutines_vars() = default;
};
