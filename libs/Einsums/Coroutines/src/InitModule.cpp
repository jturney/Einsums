...
int setup_Einsums_Coroutines() {
    ...
    if (!is_initialized) {
        register_arguments(add_Einsums_Coroutines_arguments);
        register_startup_function(initialize_Einsums_Coroutines);
        register_shutdown_function(finalize_Einsums_Coroutines);
...
EINSUMS_EXPORT void add_Einsums_Coroutines_arguments(argparse::ArgumentParser &parser) {
    /** @todo Fill in.
     *
...
void initialize_Einsums_Coroutines() {
    /// @todo Fill in.
}

void finalize_Einsums_Coroutines() {
    /// @todo Fill in.
}
