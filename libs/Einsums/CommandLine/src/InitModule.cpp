...
int setup_Einsums_CommandLine() {
    ...
    if(!is_initialized) {
        register_arguments(add_Einsums_CommandLine_arguments);
        register_startup_function(initialize_Einsums_CommandLine);
        register_shutdown_function(finalize_Einsums_CommandLine);
...
EINSUMS_EXPORT void add_Einsums_CommandLine_arguments(argparse::ArgumentParser &parser) {
    /** @todo Fill in.
     *
...
void initialize_Einsums_CommandLine() {
    /// @todo Fill in.
}

void finalize_Einsums_CommandLine() {
    /// @todo Fill in.
}
