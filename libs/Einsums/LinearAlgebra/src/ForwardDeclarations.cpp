...
template EINSUMS_EXPORT void impl_direct_product<double, double, double>(double alpha, einsums::detail::TensorImpl<double> const &A,
                                                                         einsums::detail::TensorImpl<double> const &B, double beta,
                                                                         einsums::detail::TensorImpl<double> *C);
template EINSUMS_EXPORT void impl_direct_product<std::complex<float>, std::complex<float>, std::complex<float>>(
...
template EINSUMS_EXPORT void impl_direct_product<std::complex<double>, std::complex<double>, std::complex<double>>(
...
template EINSUMS_EXPORT void impl_direct_division<float, float, float>(float alpha, einsums::detail::TensorImpl<float> const &A,
                                                                       einsums::detail::TensorImpl<float> const &B, float beta,
                                                                       einsums::detail::TensorImpl<float> *C);
template EINSUMS_EXPORT void impl_direct_division<double, double, double>(double alpha, einsums::detail::TensorImpl<double> const &A,
                                                                          einsums::detail::TensorImpl<double> const &B, double beta,
                                                                          einsums::detail::TensorImpl<double> *C);
template EINSUMS_EXPORT void impl_direct_division<std::complex<float>, std::complex<float>, std::complex<float>>(
    std::complex<float> alpha, einsums::detail::TensorImpl<std::complex<float>> const &A,
    einsums::detail::TensorImpl<std::complex<float>> const &B, std::complex<float> beta,
    einsums::detail::TensorImpl<std::complex<float>> *C);
template EINSUMS_EXPORT void impl_direct_division<std::complex<double>, std::complex<double>, std::complex<double>>(
    std::complex<double> alpha, einsums::detail::TensorImpl<std::complex<double>> const &A,
    einsums::detail::TensorImpl<std::complex<double>> const &B, std::complex<double> beta,
    einsums::detail::TensorImpl<std::complex<double>> *C);
...
impl_true_dot<std::complex<double>, std::complex<double>>(einsums::detail::TensorImpl<std::complex<double>> const &a,
                                                          einsums::detail::TensorImpl<std::complex<double>> const &b);
template EINSUMS_EXPORT void impl_gemm<float, float, float, float, float>(char transA, char transB, float alpha,
                                                                          einsums::detail::TensorImpl<float> const &A,
                                                                          einsums::detail::TensorImpl<float> const &B, float beta,
                                                                          einsums::detail::TensorImpl<float> *C);
template EINSUMS_EXPORT void impl_gemm<double, double, double, double, double>(char transA, char transB, double alpha,
                                                                               einsums::detail::TensorImpl<double> const &A,
                                                                               einsums::detail::TensorImpl<double> const &B, double beta,
                                                                               einsums::detail::TensorImpl<double> *C);
template EINSUMS_EXPORT void
