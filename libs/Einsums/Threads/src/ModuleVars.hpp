...
struct EINSUMS_EXPORT Einsums_Threads_vars final : design_pats::Lockable<std::recursive_mutex> {
    EINSUMS_SINGLETON_DEF(Einsums_Threads_vars)

    // Put module-global variables here.

private:
    explicit Einsums_Threads_vars() = default;
};
