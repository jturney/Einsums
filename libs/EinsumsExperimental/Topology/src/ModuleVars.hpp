...
struct EINSUMS_EXPORT EinsumsExperimental_Topology_vars final : design_pats::Lockable<std::recursive_mutex> {
    EINSUMS_SINGLETON_DEF(EinsumsExperimental_Topology_vars)

    // Put module-global variables here.

private:
    explicit EinsumsExperimental_Topology_vars() = default;
};
