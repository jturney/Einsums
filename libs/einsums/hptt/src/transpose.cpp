...
#include "einsums/hptt/hptt_types.hpp"
...
struct micro_kernel {
    static void execute(floatType const *__restrict__ A, const size_t lda, floatType *__restrict__ B, const size_t ldb,
...
struct micro_kernel<double, betaIsZero, conjA> {
    static void execute(double const *__restrict__ A, const size_t lda, double *__restrict__ B, const size_t ldb, double const alpha,
                        double const beta) {
...
struct micro_kernel<float, betaIsZero, conjA> {
    static void execute(float const *__restrict__ A, const size_t lda, float *__restrict__ B, const size_t ldb, float const alpha,
                        float const beta) {
...
static INLINE void macro_kernel_scalar(floatType const *__restrict__ A, const size_t lda, int blockingA, floatType *__restrict__ B,
...
static INLINE void macro_kernel(floatType const *__restrict__ A, floatType const *__restrict__ Anext, const size_t lda,
                                floatType *__restrict__ B, floatType const *__restrict__ Bnext, const size_t ldb, const floatType alpha,
...
void transpose_int_scalar(floatType const *__restrict__ A, int sizeStride1A, floatType *__restrict__ B, int sizeStride1B,
                          const floatType alpha, const floatType beta, ComputeNode const *plan) {
...
void transpose_int(floatType const *__restrict__ A, floatType const *__restrict__ Anext, floatType *__restrict__ B,
                   floatType const *__restrict__ Bnext, const floatType alpha, const floatType beta, ComputeNode const *plan) {
...
void transpose_int_constStride1(floatType const *__restrict__ A, floatType *__restrict__ B, const floatType alpha, const floatType beta,
...
Transpose<floatType>::Transpose(int const *sizeA, int const *perm, int const *outerSizeA, int const *outerSizeB, int const dim,
                                floatType const *A, const floatType alpha, floatType *B, const floatType beta,
...
static void axpy_1D(floatType const *__restrict__ A, floatType *__restrict__ B, int const myStart, int const myEnd, const floatType alpha,
...
static void axpy_2D(floatType const *__restrict__ A, int const lda, floatType *__restrict__ B, int const ldb, int const n0,
                    int const myStart, int const myEnd, const floatType alpha, const floatType beta, int numThreads) {
    if (!betaIsZero) {
