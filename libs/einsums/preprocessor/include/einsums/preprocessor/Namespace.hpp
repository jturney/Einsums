...
/**
 * @brief Handles setting up the namespace and creates a global std::string that is used by the timing mechanism to track locations.
 *
 */
...
/**
 * @brief The .cpp file equivalent of BEGIN_EINSUMS_NAMESPACE_HPP. Should only exist in one source file; otherwise, multiple definition
 * errors will occur.
 */
