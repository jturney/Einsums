...
struct function_base_vtable : vtable, copyable_vtable, callable_info_vtable {
    ...
    constexpr function_base_vtable(construct_vtable<T>, std::integral_constant<bool, true>) noexcept
        : vtable(construct_vtable<T>()), copyable_vtable(construct_vtable<T>()), callable_info_vtable(construct_vtable<T>()) {}
...
struct function_vtable<Sig, false> : function_base_vtable, callable_vtable<Sig> {
...
struct function_vtable<Sig, /*Copyable*/ true> : function_vtable<Sig, false> {
    ...
    template <typename T>
    constexpr function_vtable(construct_vtable<T>) noexcept : function_vtable<Sig, false>(construct_vtable<T>(), copyable_tag{}) {}
};
