...
struct get_function_address {
    static constexpr auto call(F const &f) noexcept -> std::size_t {
...
struct get_function_address<R (*)(Ts...)> {
    static constexpr auto call(R (*f)(Ts...)) noexcept -> std::size_t { return reinterpret_cast<std::size_t>(f); }
};
...
// clang-format off
    ...
    {
        static auto call(R (Obj::*f)(Ts...)) noexcept -> std::size_t
        {
...
#  pragma clang diagnostic pop
    ...
    {
        static auto call(R (Obj::*f)(Ts...) const) noexcept -> std::size_t
        {
#if defined(__clang__)
#  pragma clang diagnostic push
#  pragma clang diagnostic ignored "-Wstrict-aliasing"
