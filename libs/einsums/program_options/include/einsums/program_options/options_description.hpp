...
*/
class EINSUMS_EXPORT option_description {
  public:
    option_description();
 ...
 */
class EINSUMS_EXPORT options_description_easy_init {
  public:
...
*/
class EINSUMS_EXPORT options_description {
  public:
  ...
  public:
    ...
    */
    ...
    friend EINSUMS_EXPORT std::ostream &operator<<(std::ostream &os, const options_description &desc);
...
class EINSUMS_ALWAYS_EXPORT duplicate_option_error : public error {
  public:
