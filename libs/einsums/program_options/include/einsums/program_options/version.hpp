...
*/
#ifdef EINSUMS_PROGRAM_OPTIONS_VERSION
#    error EINSUMS_PROGRAM_OPTIONS_VERSION already defined
#endif
#define EINSUMS_PROGRAM_OPTIONS_VERSION 2

// Signal that implicit options will use values from next
// token, if available.
#define EINSUMS_PROGRAM_OPTIONS_IMPLICIT_VALUE_NEXT_TOKEN 1
