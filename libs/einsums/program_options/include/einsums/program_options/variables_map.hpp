...
EINSUMS_EXPORT void notify(variables_map &m);

/** Class holding value of option. Contains details about how the
    value is set and allows to conveniently obtain the value.
*/
class EINSUMS_EXPORT variable_value {
  public:
    variable_value() : m_defaulted(false) {}
    variable_value(const std::any &xv, bool xdefaulted) : v(xv), m_defaulted(xdefaulted) {}
  ...
  private:
    ...
    friend EINSUMS_EXPORT void store(const basic_parsed_options<char> &options, variables_map &m, bool);
...
/** Implements string->string mapping with convenient value casting
    facilities. */
class EINSUMS_EXPORT abstract_variables_map {
  public:
...
*/
class EINSUMS_EXPORT variables_map : public abstract_variables_map, public std::map<std::string, variable_value> {
  public:
    variables_map();
  ...
  private:
    ...
    friend EINSUMS_EXPORT void store(const basic_parsed_options<char> &options, variables_map &xm, bool utf8);
