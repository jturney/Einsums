...
*/
class EINSUMS_ALWAYS_EXPORT too_many_positional_options_error : public error {
  public:
    too_many_positional_options_error() : error("too many positional options have been specified on the command line") {}
};

/** Class thrown when there are programming error related to style */
class EINSUMS_ALWAYS_EXPORT invalid_command_line_style : public error {
  public:
    invalid_command_line_style(const std::string &msg) : error(msg) {}
};

/** Class thrown if config file can not be read */
class EINSUMS_ALWAYS_EXPORT reading_file : public error {
  public:
    reading_file(const char *filename) : error(std::string("can not read options configuration file '").append(filename).append("'")) {}
};
 ...
 *
 *   */
class EINSUMS_ALWAYS_EXPORT error_with_option_name : public error {
  protected:
    /** can be
...
class EINSUMS_ALWAYS_EXPORT multiple_values : public error_with_option_name {
  public:
    multiple_values() : error_with_option_name("option '%canonical_option%' only takes a single argument") {}
...
/** Class thrown when there are several occurrences of an
    ...
    them all. */
class EINSUMS_ALWAYS_EXPORT multiple_occurrences : public error_with_option_name {
  public:
    multiple_occurrences() : error_with_option_name("option '%canonical_option%' cannot be specified more than once") {}

    ~multiple_occurrences() noexcept {}
};

/** Class thrown when a required/mandatory option is missing */
class EINSUMS_ALWAYS_EXPORT required_option : public error_with_option_name {
  public:
 ...
 *
 *   */
class EINSUMS_ALWAYS_EXPORT error_with_no_option_name : public error_with_option_name {
  public:
...
class EINSUMS_ALWAYS_EXPORT unknown_option : public error_with_no_option_name {
  public:
...
class EINSUMS_ALWAYS_EXPORT ambiguous_option : public error_with_no_option_name {
  public:
    ambiguous_option(const std::vector<std::string> &xalternatives)
        : error_with_no_option_name("option '%canonical_option%' is ambiguous"), m_alternatives(xalternatives) {}
 ...
 *  concrete classes. */
class EINSUMS_ALWAYS_EXPORT invalid_syntax : public error_with_option_name {
  public:
    enum kind_t {
        long_not_allowed = 30,
    ...
    invalid_syntax(kind_t kind, const std::string &option_name = "", const std::string &original_token = "", int option_style = 0)
        : error_with_option_name(get_template(kind), option_name, original_token, option_style), m_kind(kind) {}
...
class EINSUMS_ALWAYS_EXPORT invalid_config_file_syntax : public invalid_syntax {
  public:
...
class EINSUMS_ALWAYS_EXPORT invalid_command_line_syntax : public invalid_syntax {
  public:
...
class EINSUMS_ALWAYS_EXPORT validation_error : public error_with_option_name {
  public:
    enum kind_t { multiple_values_not_allowed = 30, at_least_one_value_required, invalid_bool_value, invalid_option_value, invalid_option };
...
class EINSUMS_ALWAYS_EXPORT invalid_option_value : public validation_error {
  public:
...
class EINSUMS_ALWAYS_EXPORT invalid_bool_value : public validation_error {
  public:
