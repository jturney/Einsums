...
namespace einsums::program_options::command_line_style {
...
enum style_t {
    ...
    */
    ...
    unix_style = (allow_short | short_allow_adjacent | short_allow_next | allow_long | long_allow_adjacent | long_allow_next |
