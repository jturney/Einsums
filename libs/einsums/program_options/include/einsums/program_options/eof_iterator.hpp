...
#include <einsums/iterator_support/iterator_facade.hpp>
...
class eof_iterator : public iterator_support::iterator_facade<Derived, ValueType const, std::forward_iterator_tag> {
  public:
  ...
  private: // iterator core operations
    friend class einsums::iterator_support::iterator_core_access;
