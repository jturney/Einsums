...
*/
template <>
class EINSUMS_EXPORT basic_parsed_options<wchar_t> {
  public:
 ...
 */
template <class Char>
basic_parsed_options<Char> parse_command_line(int argc, const Char *const argv[], const options_description &, int style = 0,
...
*/
template <class Char>
EINSUMS_EXPORT basic_parsed_options<Char> parse_config_file(std::basic_istream<Char> &, const options_description &,
...
EINSUMS_EXPORT basic_parsed_options<Char> parse_config_file(const char *filename, const options_description &,
                                                            bool        allow_unregistered = false);
...
*/
template <class Char>
std::vector<std::basic_string<Char>> collect_unrecognized(const std::vector<basic_option<Char>> &options,
...
*/
EINSUMS_EXPORT parsed_options parse_environment(const options_description &, const std::function<std::string(std::string)> &name_mapper);
...
*/
EINSUMS_EXPORT parsed_options parse_environment(const options_description &, const std::string &prefix);
...
*/
EINSUMS_EXPORT parsed_options parse_environment(const options_description &, const char *prefix);
...
*/
EINSUMS_EXPORT std::vector<std::string> split_unix(const std::string &cmdline, const std::string &separator = " \t",
                                                   const std::string &quote = "'\"", const std::string &escape = "\\");

/** @overload */
EINSUMS_EXPORT std::vector<std::wstring> split_unix(const std::wstring &cmdline, const std::wstring &separator = L" \t",
...
*/
EINSUMS_EXPORT std::vector<std::string> split_winmain(const std::string &cmdline);

/** @overload */
EINSUMS_EXPORT std::vector<std::wstring> split_winmain(const std::wstring &cmdline);
#endif

} // namespace einsums::program_options

#include <einsums/config/warnings_suffix.hpp>
#include <einsums/program_options/detail/parsers.hpp>
