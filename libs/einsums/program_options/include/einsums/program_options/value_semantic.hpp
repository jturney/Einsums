...
*/
class EINSUMS_EXPORT value_semantic {
  public:
...
*/
template <>
class EINSUMS_EXPORT value_semantic_codecvt_helper<char> : public value_semantic {
  private: // base overrides
    EINSUMS_EXPORT void parse(std::any &value_store, const std::vector<std::string> &new_tokens, bool utf8) const override;
...
*/
template <>
class EINSUMS_EXPORT value_semantic_codecvt_helper<wchar_t> : public value_semantic {
  private: // base overrides
    EINSUMS_EXPORT void parse(std::any &value_store, const std::vector<std::string> &new_tokens, bool utf8) const override;
...
class EINSUMS_EXPORT untyped_value : public value_semantic_codecvt_helper<char> {
  public:
...
class typed_value : public value_semantic_codecvt_helper<Char>, public typed_value_base {
  public:
    /** Ctor. The 'store_to' parameter tells where to store
        the value when it's known. The parameter can be nullptr. */
    typed_value(T *store_to)
        : m_store_to(store_to), m_composing(false), m_implicit(false), m_multitoken(false), m_zero_tokens(false), m_required(false) {}
    ...
    */
    typed_value *default_value(const T &v) {
        ...
        m_default_value_as_text = einsums::string_util::to_string(v);
        return this;
    }
    ...
    */
    typed_value *implicit_value(const T &v) {
        ...
        m_implicit_value_as_text = einsums::string_util::to_string(v);
        return this;
    }
  ...
  public: // value semantic overrides
    ...
    void xparse(std::any &value_store, const std::vector<std::basic_string<Char>> &new_tokens) const override;
...
*/
EINSUMS_EXPORT typed_value<bool> *bool_switch();

/** @overload
 */
EINSUMS_EXPORT typed_value<bool> *bool_switch(bool *v);

} // namespace einsums::program_options

#include <einsums/program_options/detail/value_semantic.hpp>
