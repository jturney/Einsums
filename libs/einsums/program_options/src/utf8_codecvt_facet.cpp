...
utf8_codecvt_facet::utf8_codecvt_facet(std::size_t no_locale_manage) : std::codecvt<wchar_t, char, std::mbstate_t>(no_locale_manage) {
}
...
std::codecvt_base::result utf8_codecvt_facet::do_in(std::mbstate_t & /*state*/, const char *from, const char *from_end,
...
std::codecvt_base::result utf8_codecvt_facet::do_out(std::mbstate_t & /*state*/, const wchar_t *from, const wchar_t *from_end,
...
int utf8_codecvt_facet::do_length(std::mbstate_t &, const char *from, const char *from_end, std::size_t max_limit) const noexcept
