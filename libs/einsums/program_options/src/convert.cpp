...
std::wstring from_8_bit(const std::string &s, const std::codecvt<wchar_t, char, std::mbstate_t> &cvt) {
    ...
    return detail::convert<wchar_t>(s, std::bind(&std::codecvt<wchar_t, char, std::mbstate_t>::in, &cvt, _1, _2, _3, _4, _5, _6, _7));
}

std::string to_8_bit(const std::wstring &s, const std::codecvt<wchar_t, char, std::mbstate_t> &cvt) {
    using namespace std::placeholders;
    return detail::convert<char>(s, std::bind(&std::codecvt<wchar_t, char, std::mbstate_t>::out, &cvt, _1, _2, _3, _4, _5, _6, _7));
}

namespace {
einsums::program_options::detail::utf8_codecvt_facet utf8_facet;
}
