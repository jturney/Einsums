...
#include <einsums/assertion/CurrentFunction.hpp>
...
using assertion_handler_type = void (*)(SourceLocation const &loc, const char *expr, std::string const &msg);
...
#    define EINSUMS_ASSERT_(expr, msg)                                                                                                     \
        (!!(expr) ? void()                                                                                                                 \
                  : ::einsums::detail::handle_assert(                                                                                      \
                        ::einsums::detail::source_location{__FILE__, static_cast<unsigned>(__LINE__), EINSUMS_ASSERT_CURRENT_FUNCTION},    \
