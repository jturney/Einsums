...
struct ptr {
    ...
    EINSUMS_EXPORT friend std::ostream &operator<<(std::ostream &os, ptr const &d);
};
...
struct ipaddr {
    ...
    EINSUMS_EXPORT friend std::ostream &operator<<(std::ostream &os, ipaddr const &p);
};
...
struct current_time_print_helper {
    EINSUMS_EXPORT friend std::ostream &operator<<(std::ostream &os, current_time_print_helper const &);
};
...
struct mem_crc32 {
    ...
    EINSUMS_EXPORT friend std::ostream &operator<<(std::ostream &os, mem_crc32 const &p);
};
...
struct hostname_print_helper {
    EINSUMS_EXPORT char const *get_hostname_and_rank() const;
    EINSUMS_EXPORT char const *get_hostname() const;
    EINSUMS_EXPORT int         guess_rank() const;

    EINSUMS_EXPORT friend std::ostream &operator<<(std::ostream &os, hostname_print_helper const &h);
};
...
struct timed_var {
    ...
    double elapsed() const {
        return std::chrono::duration_cast<std::chrono::duration<double>>(std::chrono::steady_clock::now() - time_start_).count();
    }
