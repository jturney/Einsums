...
#        define EINSUMS_HAVE_THREADS_GET_STACK_POINTER
#    else
#        if defined(__x86_64__) || defined(__amd64) || defined(__i386__) || defined(__i486__) || defined(__i586__) ||  \
            defined(__i686__) || defined(__powerpc__) || defined(__arm__)
#            define EINSUMS_HAVE_THREADS_GET_STACK_POINTER
#        endif
#    endif
...
inline auto get_stack_ptr() -> std::size_t {
#    if defined(EINSUMS_GCC_VERSION)
