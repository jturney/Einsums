...
struct thread_schedule_hint {
    ...
    /// \cond NOINTERNAL
    auto operator==(thread_schedule_hint const &rhs) const noexcept -> bool {
        return mode == rhs.mode && hint == rhs.hint;
    }

    auto operator!=(thread_schedule_hint const &rhs) const noexcept -> bool { return !(*this == rhs); }
    /// \endcond
...
struct fmt::formatter<einsums::threads::detail::thread_schedule_state> : fmt::formatter<char const *> {
    ...
    auto format(einsums::threads::detail::thread_schedule_state const &t, FormatContext &ctx) {
...
struct fmt::formatter<einsums::threads::detail::thread_restart_state> : fmt::formatter<char const *> {
    template <typename FormatContext>
    auto format(einsums::threads::detail::thread_restart_state const &t, FormatContext &ctx) {
...
struct fmt::formatter<einsums::execution::thread_priority> : fmt::formatter<char const *> {
    template <typename FormatContext>
    auto format(einsums::execution::thread_priority const &t, FormatContext &ctx) {
...
struct fmt::formatter<einsums::execution::thread_stacksize> : fmt::formatter<char const *> {
    template <typename FormatContext>
    auto format(einsums::execution::thread_stacksize const &t, FormatContext &ctx) {
