...
#include <einsums/threading_base/register_thread.hpp>
...
EINSUMS_EXPORT thread_state set_thread_state(thread_id_type const &id, thread_schedule_state state = thread_schedule_state::pending,
                                             ...
                                             bool retry_on_active = true, einsums::error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT thread_id_ref_type set_thread_state(thread_id_type const &id, einsums::chrono::steady_time_point const &abs_time,
                                                   std::atomic<bool> *started, thread_schedule_state state = thread_schedule_state::pending,
                                                   thread_restart_state       stateex  = thread_restart_state::timeout,
                                                   execution::thread_priority priority = execution::thread_priority::normal,
                                                   bool retry_on_active = true, error_code &ec = throws);

inline thread_id_ref_type set_thread_state(thread_id_type const &id, einsums::chrono::steady_time_point const &abs_time,
                                           thread_schedule_state      state           = thread_schedule_state::pending,
                                           thread_restart_state       stateex         = thread_restart_state::timeout,
                                           execution::thread_priority priority        = execution::thread_priority::normal,
                                           bool                       retry_on_active = true, error_code                       &/*ec*/ = throws) {
    return set_thread_state(id, abs_time, nullptr, state, stateex, priority, retry_on_active, throws);
}
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
inline thread_id_ref_type set_thread_state(thread_id_type const &id, einsums::chrono::steady_duration const &rel_time,
                                           thread_schedule_state      state    = thread_schedule_state::pending,
                                           thread_restart_state       stateex  = thread_restart_state::timeout,
                                           execution::thread_priority priority = execution::thread_priority::normal,
                                           bool retry_on_active = true, error_code &ec = throws) {
    return set_thread_state(id, rel_time.from_now(), state, stateex, priority, retry_on_active, ec);
}
...
EINSUMS_EXPORT char const *get_thread_backtrace(thread_id_type const &id, error_code &ec = throws);
EINSUMS_EXPORT char const *set_thread_backtrace(thread_id_type const &id, char const *bt = nullptr, error_code &ec = throws);
#else
#    if !defined(DOXYGEN)
EINSUMS_EXPORT debug::detail::backtrace const *get_thread_backtrace(thread_id_type const &id, error_code &ec = throws);
EINSUMS_EXPORT debug::detail::backtrace const *set_thread_backtrace(thread_id_type const &id, debug::detail::backtrace const *bt = nullptr,
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT thread_state get_thread_state(thread_id_type const &id, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT std::size_t get_thread_phase(thread_id_type const &id, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT bool get_thread_interruption_enabled(thread_id_type const &id, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT bool set_thread_interruption_enabled(thread_id_type const &id, bool enable, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT bool get_thread_interruption_requested(thread_id_type const &id, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT void interrupt_thread(thread_id_type const &id, bool flag, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT void interruption_point(thread_id_type const &id, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT execution::thread_priority get_thread_priority(thread_id_type const &id, error_code &ec = throws);
...
///                   parameter \a ec. Otherwise it throws an instance
///                   of einsums#exception.
EINSUMS_EXPORT std::ptrdiff_t get_stack_size(thread_id_type const &id, error_code &ec = throws);

///////////////////////////////////////////////////////////////////////////
/// \cond NOINTERNAL
EINSUMS_EXPORT void run_thread_exit_callbacks(thread_id_type const &id, error_code &ec = throws);

EINSUMS_EXPORT bool add_thread_exit_callback(thread_id_type const &id, util::detail::function<void()> const &f, error_code &ec = throws);

EINSUMS_EXPORT void free_thread_exit_callbacks(thread_id_type const &id, error_code &ec = throws);

///////////////////////////////////////////////////////////////////////////
EINSUMS_EXPORT std::size_t get_thread_data(thread_id_type const &id, error_code &ec = throws);

EINSUMS_EXPORT std::size_t set_thread_data(thread_id_type const &id, std::size_t data, error_code &ec = throws);

EINSUMS_EXPORT std::size_t &get_continuation_recursion_count() noexcept;
EINSUMS_EXPORT void         reset_continuation_recursion_count() noexcept;
/// \endcond
...
///         function will throw an \a einsums#exception with an error code of
///         \a einsums#yield_aborted if it is signaled with \a wait_aborted.
///         If called outside of a einsums-thread, this function will throw
///         an \a einsums#exception with an error code of \a einsums::null_thread_id.
///         If this function is called while the thread-manager is not
///         running, it will throw an \a einsums#exception with an error code of
///         \a einsums#invalid_status.
EINSUMS_EXPORT threads::detail::thread_pool_base *get_pool(thread_id_type const &id, error_code &ec = throws);
} // namespace einsums::threads::detail
...
///
/// \note Must be called from within a einsums-thread.
///
/// \throws If <code>&ec != &throws</code>, never throws, but will set \a ec
///         to an appropriate value when an error occurs. Otherwise, this
///         function will throw an \a einsums#exception with an error code of
...
///         \a einsums#invalid_status.
///
EINSUMS_EXPORT einsums::threads::detail::thread_restart_state
               suspend(threads::detail::thread_schedule_state state, threads::detail::thread_id_type id,
                       detail::thread_description const &description = detail::thread_description("this_thread::suspend"), error_code &ec = throws);
...
///         \a einsums#invalid_status.
///
inline einsums::threads::detail::thread_restart_state
suspend(threads::detail::thread_schedule_state state  = threads::detail::thread_schedule_state::pending,
        detail::thread_description const &description = detail::thread_description("this_thread::suspend"), error_code &ec = throws) {
...
///
EINSUMS_EXPORT einsums::threads::detail::thread_restart_state
               suspend(einsums::chrono::steady_time_point const &abs_time, threads::detail::thread_id_type id,
                       detail::thread_description const &description = detail::thread_description("this_thread::suspend"), error_code &ec = throws);
...
///
inline einsums::threads::detail::thread_restart_state
suspend(einsums::chrono::steady_time_point const &abs_time,
        detail::thread_description const &description = detail::thread_description("this_thread::suspend"), error_code &ec = throws) {
...
///
inline einsums::threads::detail::thread_restart_state
suspend(einsums::chrono::steady_duration const &rel_time,
        detail::thread_description const &description = detail::thread_description("this_thread::suspend"), error_code &ec = throws) {
...
///
inline einsums::threads::detail::thread_restart_state
suspend(einsums::chrono::steady_duration const &rel_time, threads::detail::thread_id_type const &id,
        detail::thread_description const &description = detail::thread_description("this_thread::suspend"), error_code &ec = throws) {
...
///
inline einsums::threads::detail::thread_restart_state
suspend(std::uint64_t ms, detail::thread_description const &description = detail::thread_description("this_thread::suspend"),
        error_code &ec = throws) {
    return suspend(std::chrono::milliseconds(ms), threads::detail::invalid_thread_id, description, ec);
}
...
///         running, it will throw an \a einsums#exception with an error code of
///         \a einsums#invalid_status.
EINSUMS_EXPORT threads::detail::thread_pool_base *get_pool(error_code &ec = throws);

/// \cond NOINTERNAL
// returns the remaining available stack space
EINSUMS_EXPORT std::ptrdiff_t get_available_stack_space();

// returns whether the remaining stack-space is at least as large as
// requested
EINSUMS_EXPORT bool has_sufficient_stack_space(std::size_t space_needed = static_cast<std::size_t>(8) * EINSUMS_THREADS_STACK_OVERHEAD);
/// \endcond
} // namespace einsums::this_thread
