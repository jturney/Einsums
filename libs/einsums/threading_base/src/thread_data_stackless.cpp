...
einsums::detail::internal_allocator<thread_data_stackless> thread_data_stackless::thread_alloc_;

thread_data_stackless::~thread_data_stackless() {
    EINSUMS_LOG(debug, "~thread_data_stackless({}), description({}), phase({})", fmt::ptr(this), this->get_description(),
