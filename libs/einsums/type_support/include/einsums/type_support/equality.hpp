...
struct equality_result<T, U, std::void_t<decltype(std::declval<const T &>() == std::declval<const U &>())>> {
...
template <typename T, typename U>
struct inequality_result<T, U, std::void_t<decltype(std::declval<const T &>() != std::declval<const U &>())>> {
    using type = decltype(std::declval<const T &>() != std::declval<const U &>());
};
...
struct is_weakly_equality_comparable_with_impl<
    T, U, std::void_t<equality_result_t<T, U>, equality_result_t<U, T>, inequality_result_t<T, U>, inequality_result_t<U, T>>>
    : std::true_type {};

template <typename T, typename U>
struct is_weakly_equality_comparable_with : is_weakly_equality_comparable_with_impl<std::decay_t<T>, std::decay_t<U>> {};
...
template <typename T, typename U>
struct is_equality_comparable_with : is_weakly_equality_comparable_with_impl<std::decay_t<T>, std::decay_t<U>> {};

template <typename T, typename U>
inline constexpr bool is_equality_comparable_with_v = is_equality_comparable_with<T, U>::value;

template <typename T>
struct is_equality_comparable : is_weakly_equality_comparable_with_impl<std::decay_t<T>, std::decay_t<T>> {};
