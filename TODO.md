...
## Completed (2026-03-31 — 2026-04-02)
...
- ~~**Execution order numbers**~~ — removed: execution order is determined by optimization passes and dataflow executor at runtime, not by visual graph topology
...
### Completed (2026-04-03 — 2026-04-05)
...
### Completed (2026-04-15 — 2026-04-17)
...
Build out `textDocument/codeAction` + LSP rename into a proper refactoring UX on par with CLion. Clangd already returns most of the individual operations as tweak-class code actions; the gap is UI — we need dedicated entry points, a "Refactor This..." menu that filters to `refactor.*`, and preview dialogs for multi-file rewrites.
...
## ComputeGraph
  ...
  header as the slice variants and have the same template shape — would just need
