...
function(einsums_create_configuration_summary message module_name)
  ...
  if("${module_name_uc}" STREQUAL "EINSUMS")
    configure_file("${EINSUMS_SOURCE_DIR}/cmake/templates/config_defines_strings.hpp.in"
                   "${EINSUMS_BINARY_DIR}/libs/einsums/config/include/einsums/config/config_strings.hpp" @ONLY)
  endif()
endfunction()
