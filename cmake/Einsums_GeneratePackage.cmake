...
write_basic_package_version_file(
    ...
    VERSION ${EINSUMS_VERSION} COMPATIBILITY AnyNewerVersion
)
...
install(EXPORT einsums_internal_targets NAMESPACE EinsumsInternal::
...
export(TARGETS ${EINSUMS_EXPORT_TARGETS} NAMESPACE Einsums::
...
configure_file(
    cmake/templates/EinsumsConfig.cmake.in
    "${CMAKE_CURRENT_BINARY_DIR}/lib/cmake/${EINSUMS_PACKAGE_NAME}/EinsumsConfig.cmake"
    ESCAPE_QUOTES @ONLY
)
...
configure_file(
    cmake/templates/EinsumsMacros.cmake.in
    "${CMAKE_CURRENT_BINARY_DIR}/lib/cmake/${EINSUMS_PACKAGE_NAME}/EinsumsMacros.cmake"
    ESCAPE_QUOTES @ONLY
)
