...
function(einsums_target_architecture output_var)
    if(APPLE AND CMAKE_OSX_ARCHITECTURES)
        ...
        if(NOT EINSUMS_INTERNAL_ARCH_DETECT)
            ...
            # obviously because of the presence of the #error preprocessor directives... but by exploiting the
            # preprocessor in this way, we can detect the correct target architecture even when cross-compiling, since
            # the program itself never needs to be run (only the compiler/preprocessor)
            try_run(
            ...
            # If we are compiling with an unknown architecture this variable should already be set to "unknown" but in
            # the case that it's empty (i.e. due to a typo in the code), then set it to unknown
            if(NOT ARCH)
                set(ARCH unknown)
            endif()
