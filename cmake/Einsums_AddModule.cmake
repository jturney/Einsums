...
function(einsums_add_module libname modulename)
  ...
  if(${modulename}_GLOBAL_HEADER_GEN)
    ...
    configure_file("${PROJECT_SOURCE_DIR}/cmake/templates/global_module_header.hpp.in" "${global_header}")
  ...
  if(${modulename}_CONFIG_FILES)
    ...
    configure_file("${CMAKE_CURRENT_SOURCE_DIR}/cmake/templates/config_version.hpp.in" "${global_config_file}" @ONLY)
    ...
    einsums_write_config_defines_file(TEMPLATE "${CMAKE_CURRENT_SOURCE_DIR}/cmake/templates/config_defines.hpp.in"
  ...
  if(NOT module_is_interface_library)
    set_target_properties(einsums_${modulename} PROPERTIES FOLDER "Core/Modules/${libname_cap}"
  ...
  if(EINSUMS_WITH_UNITY_BUILD AND NOT module_is_interface_library)
    ...
    set_target_properties(einsums_${modulename} PROPERTIES UNITY_BUILD_CODE_BEFORE_INCLUDE
