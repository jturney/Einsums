...
function(einsums_add_executable name)
    ...
    einsums_debug("Add exeutable ${name}: ${name}_SOURCE_ROOT: ${${name}_SOURCE_ROOT}")
    ...
    einsums_add_library_headers_noglob(${name}_executable HEADERS "${${name}_HEADERS}")
    ...
    if(${name}_OUTPUT_SUFFIX)
        if(MSVC)
            ...
            set_target_properties(
                ${name} PROPERTIES RUNTIME_OUTPUT_DIRECTORY "${EINSUMS_WITH_BINARY_DIR}/bin/${${name}_OUTPUT_SUFFIX}"
            )
        endif()
    endif()
