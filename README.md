...
The third figure shows the PackedGemm dispatch engine on scrambled contractions, index patterns that do not map directly onto a BLAS call, such as the CCSD-like ring term in the figure title, across three engine generations.
